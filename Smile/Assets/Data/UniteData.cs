...
public class UniteData
{
    ...
    public static int Difficulty = 1; //게임 난이도 tuto = 0 / easy = 1 / normal = 2 / hard = 3 / world 2 easy = 4 ...
    ...
    public static string Closed_Monster = "Rose"; //최근접 몬스터 ["Rose", "Cosmos", "MorningGlory", "Poppy", "Pasque", "Bose"]
