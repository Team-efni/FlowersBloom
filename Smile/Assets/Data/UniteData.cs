...
public class UniteData
{
    ...
    public static int Difficulty = 1; //게임 난이도 easy = 1
    ...
    public static string Selected_Character = PlayerPrefs.GetString("Selected_Character", "Tulip"); //유저가 선택한 캐릭터 ["Dandelion", "Tulip"]
